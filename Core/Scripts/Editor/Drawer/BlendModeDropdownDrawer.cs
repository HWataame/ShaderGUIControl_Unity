/*
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
マテリアルのプロパティ上でブレンドモード設定のドロップダウンを描画するクラス

BlendModeDropdownDrawer.cs
────────────────────────────────────────
バージョン: 1.0.0
...
namespace HW.ShaderDropdown.Editor.Drawer
{
    ...
    /// マテリアルのプロパティ上でブレンドモード設定のドロップダウンを描画するクラス
    /// </summary>
    /// <remarks>プロパティに[BlendModeDropdown]を付与すると使用可能</remarks>
    internal sealed class BlendModeDropdownDrawer : MaterialPropertyDrawer
    {
        /// <summary>
        /// 描画処理
        /// </summary>
        ...
        public sealed override void OnGUI(Rect position, MaterialProperty prop, GUIContent label, MaterialEditor editor)
        {
            ...
            {
                // ブレンドモード設定のフィールドを描画する
                BlendModeGUI.BlendModeDropdown(position, prop, label);
            }
        }
    }
}
